        ...
        <main>
          ...
          <article>
            ...
            <div>
              <h4>Kothey Momos</h4>
              <div>
                <span>{order.orderItems.kotheyMomos.quantity}</span> x{" "}
                <span>{order.orderItems.kotheyMomos.price}</span>
              </div>
            </div>
            <div>
              <h4>Steamed Momos</h4>
              <div>
                <span>{order.orderItems.steamedMomos.quantity}</span> x{" "}
                <span>{order.orderItems.steamedMomos.price}</span>
              </div>
            </div>
            <div>
              <h4>Fried Momos</h4>
              <div>
                <span>{order.orderItems.friedMomos.quantity}</span> x{" "}
                <span>{order.orderItems.friedMomos.price}</span>
              </div>
            </div>
